...
#' \code{what} will add two additional columns with the lower and upper boounds
#' of a conditional prediction interval for each test prediction to the
#' dataframe; and including \code{"cons.interval"} will add to the dataframe
...
#'
#' @return A dataframe with one or more of the following columns, as described
